...
namespace WebstarMasterApp.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,OHIP,FirstName,MiddleName,LastName,DOB,ExpYrVisits,Timestamp,DoctorID")] Patient patient)
        {
            ...
            ViewBag.DoctorID = new SelectList(db.Doctors, "ID", "FirstName", patient.DoctorID);
            return View(patient);
        }
